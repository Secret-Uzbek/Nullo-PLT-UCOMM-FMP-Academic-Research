# FMP Publication & Research Mandate (EN / RU)
...
6. Готовить шаблоны и рассылки авторам/инстR&D центрациям от имени Уполномочителя при явном разрешении на контакт.
